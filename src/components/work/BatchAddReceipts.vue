<template>
    <el-dialog class="dialog-w1300-h700-hn" title="选择产品类型" v-model="saveSuccess">
        <div class="batch-main" v-loading="isLoading">
            ...
            <div class="batch-page-one" v-if="listType == '单据'">
                <div class="operate-bar-bottom">
                    ...
                    <div class="batch-select-wrap select-w100">
                        <el-select @change="changePosition" filterable v-model="modelType" placeholder="全部">
                            <el-option
            ...
            <div class="batch-footer">
                <div class="btn-wrap">
                    <div class="cenl-btn btn" @click="saveSuccess = false">取消</div>
...
import {seekGetReceiptList, seekBatchAddByOrderNum, seekBatchAddByProductList, getProductTypeList, seekProductClassList} from "./../../Api/commonality/seek"
import {statusModuleType} from "./../../Api/commonality/status"
import {operateCreatReceipt, operateProductList} from "./../../Api/commonality/operate"
