<template>
    <div class="dropDown-wrap">
        <span class="title-name" :class="optionData.titleInfo == '' ? '' : 'select'">
            ...
            <i class="el-icon-circle-close" title="清除" @click.stop="clearTitleInfo" v-else></i>
        </span>
        <ul class="drop-list">
            <li :class="{active: actIndex == index}" v-for="(item, index) in propList" @click.stop="itemClick(item, index)">{{getDataType(dataType, item)}}</li>
        </ul>
    </div>
</template>
