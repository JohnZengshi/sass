  ...
  methods: {
    ...
    changeFileInput(ev) {
      ...
      if (extName == "sql") {
        ...
        this.$http.post(url, fileData).then(
          response => {
        ...
        res => {
          ...
          for (let i = 0; i < this.dataList.length; i++) {
            if (typeof this.dataList[i].recoverTime == "number") {
              let year = this.dataList[i].recoverTime
                .toString()
                .substring(0, 4);
              let month = this.dataList[i].recoverTime
                .toString()
                .substring(4, 6);
              let data = this.dataList[i].recoverTime
                .toString()
                .substring(6, 8);
              let hour = this.dataList[i].recoverTime
                .toString()
                .substring(8, 10);
              let time = this.dataList[i].recoverTime
                .toString()
                .substring(10, 12);
              this.dataList[i].recoverTime =
      ...
      span:nth-child(1) {
        ...
        .infoDiag {
          ...
          .infoDiag-content {
            padding: 0 28px;
            p {
              background: url("./../../src/assets/img/indent.jpg") no-repeat
                left 3px;
              font-size: 12px;
              color: #959595;
              margin-bottom: 20px;
