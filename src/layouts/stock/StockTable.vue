...
export default {
  ...
  methods: {
    ...
    tabPrin() {
      if (
        (this.dataGridStorage.productTypeList &&
          this.dataGridStorage.productTypeList.length == 0) ||
        (this.dataGridStorage.printDetailList &&
          this.dataGridStorage.printDetailList.length == 0)
      ) {
        this.$message({
          type: "error",
          message: "暂无数据打印"
