<template>
  <div class="dg-container">
    ...
    <div class="datagrid-container" :class="{[!browserType ? 'animat-scroll-firefox' : 'animat-scroll']:slipPointer}" v-show="dgDataList.length > 0 "
      @scroll="watchScroll($event)" :style="'padding-left:'+ fixedFullSize +'px'" ref="datagrid">
      <!--左边固定表格区-->
      <dgridBody ref="dgridfixed" :dgDataList="dgDataList" :synopsiData="synopsiData" :orderNum="orderNum" :smallDataList="smallDataList"
        :selectContainer="selectContainer" :addDatalist="addDatalist" :activeClassIndex="activeClassIndex" :fixedFullSize="fixedFullSize"
        @addRow="add" @deletegoods="deletegoods" @updataSelectContainer="updataSelectContainer" @updataEditApi="updataEditApi"
    ...
    <!--表尾-->
    <dgridfooter :isRefreshFooter="isRefreshFooter" :allSynopsiData="allSynopsiData" :smallDataList="smallDataList" ref="footer"
