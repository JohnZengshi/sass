	...
	<div>
		...
		<div class="tb-tr" v-for="(tb,index1) in tempArray" :key="index1">
			<div class="tb-td" v-for="(tab,index2) in detailDataGridColumn" :key="index2"
				...
				<span style="width:370px;height:90px;line-height: 20px;margin-top:25px; display:block;white-space:normal;word-wrap:break-word;" v-if="tab.childType == 'styleNames'">{{tb.styleName}}</span>
