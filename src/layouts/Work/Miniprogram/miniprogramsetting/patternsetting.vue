  ...
  <div class="data-view">
    ...
    <div class="tpl-scroll">
        <div class="optionWrap">
            ...
            <ul ref="nextul" class="nextul">
              <li @click="getPatternitem(item, index)" @mouseover="nextin" :key="index" :class="patternitem==item ? 'active' :''" v-for="(item, index) in patterntype">
								{{item.classesName}}
							</li>
						</ul>
            ...
            <ul ref="nextul2" class="nextul">
              <li @click="getPatternitem2(item, index)" @mouseover="nextin2" :key="index" :class="qualityitem==item ? 'active' :''" v-for="(item, index) in qualitytype">
								{{item.classesName}}
							</li>
						</ul>
            ...
            <ul ref="nextul3" class="nextul">
              <li @click="getPatternitem3(item, index)" @mouseover="nextin3" :key="index" :class="bijouitem==item ? 'active' :''" v-for="(item, index) in bijoutype">
								{{item.classesName}}
							</li>
						</ul>
    ...
    <div style="height:600px;width:100%;margin-top:50px;"  v-loading="fullLoading" element-loading-text="拼命进行中...">
              <reportdetailtab 
                     ...
                     :shopid="shopId"
                     @sortList ="sortList"
                      @messageBack="messageBack" @lazyloadSend="lazyloadSend"></reportdetailtab>
    </div>
     ...
     getList(){
      ...
      getmallsClassification(){//列表请求函数
        ...
        let options ={
          ...
          orderBy:this.integrateId,// 综合排序  1 综合排序，2热度排序，3最新排序
