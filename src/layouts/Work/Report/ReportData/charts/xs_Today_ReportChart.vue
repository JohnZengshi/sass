...
<div class="rp_chart_item">
	...
	<div class="rp_chart_total">
		...
		<span class="_total" :title="chart_configData.totalNum"><b v-text="chart_configData.totalCost"></b>件</span>
...
import {seekReportsHomeXS} from './../../../../../Api/commonality/operate.js'
...
export default{
	...
	methods:{
		...
		getReportsHome(){
			...
			seekReportsHomeXS(option).then( (res)=>{
				if( res.data.state == 200){
					setTimeout(()=>{
						console.log('今日销售数据:',res);
