    ...
    <div class="RP_report_wrapper ui-page-max-width report_table_fixed" v-if="isPrint==0" v-loading="loading" element-loading-text="数据查询中">
      ...
      <div class="Rp_title_container">
        ...
        <div class="Rp_crumbs">
          ...
          <router-link tag="span" to="/work/report/" class="path_crumbs">报表</router-link> > <span class="txt">修改</span>
        </div>
      ...
      <div class="Rp_dataGrid_container">
        <div class="rp_gridState">
          <p class="side-nav"><i class="iconfont icon-liebiao"></i>修改报表</p>
        ...
        <span>打印报表</span>
      	...
      	<!--打印模块-->
				<div style="display: none;">
						...
						<intelligence-type-template v-if="this.tabClassActive.index==1" title="修改" ref="intelligenceTypeTemplate" :sellList="dataGridStorage" :headerData="printSelectDate"></intelligence-type-template>
						<project-type-template v-if="this.tabClassActive.index==2" title="修改" ref="projectTypeTemplate" :sellList="dataGridStorage" :headerData="printSelectDate"></project-type-template>
						<custom-template v-if="this.tabClassActive.index==3" title="修改" ref="customTemplate" :sellList="dataGridStorage" :headerData="printSelectDate"></custom-template>
				</div>
...
<script>
  ...
  import { seekGetReportsXG } from 'Api/commonality/operate'
  import {
    seekRepositoryList,
  ...
  import TablePrint from './newPrint/reportDetailTab'
	...
	import detailTemplate from "@/components/jcp-print/update/detail-template";
