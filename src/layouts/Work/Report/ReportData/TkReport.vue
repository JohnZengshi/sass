...
<div class="RP_report_wrapper ui-page-max-width report_table_fixed" v-if="isPrint==0" v-loading="loading"  element-loading-text="数据查询中">
	...
	<div class="Rp_dataGrid_container">
		<div class="rp_gridState">
			<p class="side-nav"><i class="iconfont icon-liebiao"></i>退库报表</p>
	...
	<div style="display: none;">
			<detail-template v-if="this.tabClassActive.index==0" title="退库" ref="detailTemplate" :sellList="dataGridStorage" :headerData="printSelectDate"></detail-template>
			<intelligence-type-template v-if="this.tabClassActive.index==1" title="退库" ref="intelligenceTypeTemplate" :sellList="dataGridStorage" :headerData="printSelectDate"></intelligence-type-template>
			<project-type-template v-if="this.tabClassActive.index==2" title="退库" ref="projectTypeTemplate" :sellList="dataGridStorage" :headerData="printSelectDate"></project-type-template>
			<custom-template v-if="this.tabClassActive.index==3" title="退库" ref="customTemplate" :sellList="dataGridStorage" :headerData="printSelectDate"></custom-template>
	</div>
...
import find from 'lodash/find'
 import {seekOutStorageReport} from './../../../../Api/commonality/operate.js'
 import {
 	seekRepositoryList, 
