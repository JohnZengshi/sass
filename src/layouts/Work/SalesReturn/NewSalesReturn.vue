      ...
      <div class="new-table-wrap" ref="temp_wrap">
        <div class="new-table-template">
          <section class="body-box" ref="body_box">
            ...
            <div id="body-row2" class="body-row2 actions-status" :data-status="curStatus.statusName" :class="{'animat-scroll':curStatus.slipPointer, 'color1': nowStatus == 1, 'color2': nowStatus == 2,
            ...
            <div class="Rp_dataGrid_container body-row4" :class="{'animat-scroll':curStatus.slipPointer }">
              ...
              <div class="btn-list">
                ...
                <!-- 审核状态，不是已锁定，职位（不是公司人都可以），制单人 -->
                <div class="btn" v-if="receiptsIntroList.checkType == '1' && isMakeMan == true" @click="operateSubmit(4)">
                  <span class="iconfont icon-tijiaoshenhe"></span>
                  <span>提交审核</span>
                </div>
