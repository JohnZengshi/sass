<template>
  <div class="transfer">
    <div class="data" v-show="!showTable">
      ...
      <span class="text1" @click="back()">调柜单据></span>
    ...
    <div class="goods-desc">
      <div class="desc-one">
        ...
        <span class="one">调出柜组：</span>
        <span class="two">{{result.groupOutName}}</span>
        <span class="one">调入柜组：</span>
        <span class="two">{{result.groupInName}}</span>
      </div>
      <!--<div class="desc-two">
...
<!-- 打印模块 -->
    <div class="print-content" @click="print" v-show="showTable" ref="printContent">
      ...
      <div class="goods-desc">
        <div class="desc-one">
          <span class="one">单&nbsp;&nbsp;据&nbsp;号：</span><span class="two">{{result.orderNum}}</span>
          <span class="one">调出柜组：</span><span class="two">{{result.groupOutName}}</span>
          <span class="one">调入柜组：</span><span class="two">{{result.groupInName}}</span>
        </div>
        <!--<div class="desc-two">
          <span class="one">调出库位</span><span class="three">{{result.storageInName}}</span>
        </div>-->
...
<script>
  import Vue from 'vue'
  import {seekTransDGData} from './../../../../../Api/commonality/operate'
  import rightDiv from './../../../../../components/work/TransferCabinetReceiptsIntro.vue'
  ...
  export default {
    ...
    methods: {
      ...
      // let orderNum = sessionStorage.getItem("orderNumber")
        ...
        seekTransDGData(transdata).then((res) => {
