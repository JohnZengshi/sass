    ...
    <div class="print-content" @click="print" v-show="showTable" ref="printContent">
      ...
      <div class="main-table" v-show="rightTable[0]">
        ...
        <div class="people">
          ...
          <!--<span style="float:right; margin-right:20px;">接收人：{{result.takeManName}}</span>-->
        </div>
      </div>
    </div>
...
<script>
  import Vue from 'vue'
  import {seekOutStorageData} from './../../../../../Api/commonality/operate'
  import rightDiv from './../../../../../components/work/StorageReturnReceiptsIntro.vue'
  ...
  export default {
    ...
    methods: {
      ...
      // let orderNum = sessionStorage.getItem("orderNumber")
        ...
        seekOutStorageData(transdata).then((res) => {
