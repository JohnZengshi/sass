<template>
  <div class="transfer">
    ...
    <div class="goods-desc">
      ...
      <div class="desc-two">
        <span class="one">发货库位：</span><span class="three">{{result.storageName}}</span>
      </div>
    </div>
    ...
    <div class="print-content" @click="print" v-show="showTable" ref="printContent">
      ...
      <div class="main-table" v-show="rightTable[0]">
        ...
        <div class="people">
          ...
          <span style="float:right; margin-right:20px; width:180px; display:block;">接收人：{{result.takeManName}}</span>
        </div>
      </div>
    </div>
...
<script>
  import Vue from 'vue'
  import {seekSendShopData} from './../../../../../Api/commonality/operate'
  import rightDiv from './../../../../../components/work/SippingReceiptsIntro.vue'
  ...
  export default {
    ...
    methods: {
      ...
      // let orderNum = sessionStorage.getItem("orderNumber")
        ...
        seekSendShopData(transdata).then((res) => {
