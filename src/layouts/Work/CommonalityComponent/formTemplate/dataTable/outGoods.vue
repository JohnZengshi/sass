<template>
  <div class="transfer">
    <div class="data" v-show="!showTable">
      ...
      <span class="text1" @click="back()">退货单据></span>
    ...
    <div class="goods-desc">
      ...
      <div class="desc-two">
        <span class="one">接收库位：</span><span class="three">{{result.storageName}}</span>
      </div>
    </div>
    ...
    <div class="print-content" @click="print" v-show="showTable" ref="printContent">
      ...
      <div class="main-table" v-show="rightTable[0]">
        ...
        <div class="people">
          ...
          <span>接收人：{{result.takeManName}}</span>
        </div>
      </div>
    </div>
...
<script>
  import Vue from 'vue'
  import {seekOutShopData} from './../../../../../Api/commonality/operate'
  import rightDiv from './../../../../../components/work/SalesReturnReceiptsIntro.vue'
  ...
  export default {
    ...
    methods: {
      ...
      // let orderNum = sessionStorage.getItem("orderNumber")
        ...
        seekOutShopData(transdata).then((res) => {
