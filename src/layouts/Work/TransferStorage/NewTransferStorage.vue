                    ...
                    <div class="new-table-template">
                        <section class="body-box" ref="body_box">
                            ...
                            <div class="body-header skin-shield" ref="body_header">
                                <ul class="header-nav">
                                    <li @click="goPreviousPage"><i style="font-size: 20px; margin-right: 10px;" class="iconfont icon-tiaoku"></i>调库<span>&nbsp;></span></li>
                                    <li class="on">单据详情</li>
                                </ul>
                        ...
                        'color7': nowStatus == 7, 'color8': nowStatus == 8}"  
                                    ...
                                    <div class="left-main">
                                        ...
                                        <div class="select-container">
                                            <div class="item supplier">
                                                <span v-text="receiptsIntroList.storageName2"></span>
                                                <div class="item-name">调出库位</div>
                                            </div>
                                            <div class="item shop">
                                                ...
                                                <select-drop
                                                    ...
                                                    dataType="库位"
                                                    :isDrop="true"
                                                    v-if="nowStatus != 2 && nowStatus != 3 && nowStatus != 4 && nowStatus != 5 && nowStatus != 6 && isRole == 'Y'"
                            ...
                            >
                                    ...
                                    <ul class="header-wrap-btn">
                                        <template v-if="isMakeOrderManId">
                                            <li v-if='addRole && dataGridOptions.type == 1' class="confirm-btn">
                                                <!--单个添加--> <input ref="inputDom" @keyup.enter="addNewGoods" style="width:150px;"  @focus="changeborder($event,1)" @blur="changeborder($event,2)"  v-model="enterOrderNum" type="text" placeholder="扫描/输入条码号添加商品">
                                            </li>
                                        ...
                                        <!--<li class="confirm-btn" v-show="receiptsIntroList.checkType == '1'" @click="sendGoods">
                                            收货
                                        </li>-->
                                    </ul>
                                </div>
                                ...
                                <div class="btn-list">
                                    <div class="btn" v-if="nowStatus == 1" @click="operateSubmit(4)">
                                        <span class="iconfont icon-fahuo1"></span>
                                        <span>发出</span>
                                    </div>
                                    <div class="btn" v-if="nowStatus == 3 && isMakeMan|| nowStatus == 4 && isMakeMan" @click="operateSubmit(1)">
                                        <span class="iconfont icon-shouyindadan"></span>
                                        <span>撤销发货</span>
                                    </div>
                                    <div class="btn" v-if="nowStatus == '4'" @click="sendGoods">
...
import {seekReceiptDKSynopsis, seekReceiptStatusList, seekGoodsList, seekSettingUserRole} from './../../../Api/commonality/seek'
import {seekTransferStorageData, operateProductList, operateReceiptOperation, operateRemarkOperation, operateDeleteByOrderNumber, operateHandleXGReceipt, operateSubmitAudit, operateTakeOrder} from './../../../Api/commonality/operate'
...
export default {
    ...
    mounted () {
        ...
        // this.$refs.fixed_mask.style.left = this.$refs.body_box.getBoundingClientRect().left -10 + 'px'
    ...
    computed: {
        ...
        getOperateTakeOrderName () {
            console.log(this.receiptStatus)
    ...
    methods: {
            ...
            if (this.nowStatus == 2) {
                ...
                cancelButtonText: '取消',
                    ...
                    operateDeleteByOrderNumber(options).then((res) => {
                        if (res.data.state == 200) {
                            this.$router.push({path: '/work/transferStorage'})
                            this.$message({
                                type: 'success',
                                message: '删除成功!'
                            });
        ...
        receiptStatusList () {
            ...
            seekReceiptStatusList(options).then((res) => {
                ...
                //     this.stepIndex = 1
                //     this.$refs.mask.style.width = "250px"
                // } else if (res.data.data.nowStatus == "3") {
                //     this.stepIndex = 2
                //     this.$refs.mask.style.width = "500px"
                // } else if (res.data.data.nowStatus == "4") {
                //     this.stepIndex = 3
                //     this.$refs.mask.style.width = "750px"
                // } else if (res.data.data.nowStatus == "5") {
                //     this.stepIndex = 4
                //     this.$refs.mask.style.width = "1000px"
        ...
        */
        ...
        //     seekTransferStorageData( this.propOptons ).then((res) => {
        //         if (res.data.state === 200) {
        //             //数据表格数据
        //             console.log(res)
        ...
        sendlayLoad () {
          this.dataGridOptions.pageSize += 15
          seekTransferStorageData(this.dataGridOptions).then((res) => {
            if (res.data.state == 200) {
              this.dataGridStorage = res.data.data
              this.loading = false
            }
        ...
        getSeekSellReceiptsIntro () { // 单据简介
            ...
            seekReceiptDKSynopsis(options).then((response) => {
                if (response.data.state === 200) {
                    ...
                    console.log(this.receiptsIntroList) // 1 待审核  2 审核中  3 已审核
