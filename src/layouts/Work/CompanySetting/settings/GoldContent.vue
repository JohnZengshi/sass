<template>
    <transition name="tp-ani">
        <div class="model-wrap">
            <div class="model-title"><i class="iconfont icon-liebiao"></i>金含量</div>
            <div class="model-content" >
                <div v-loading="isLoading" element-loading-text="拼命加载中">
                    <div class="type-block">
                        <div class="item-title">金含量<span class="add-btn" @click="addDialogAct()">+分类</span></div>
            ...
            <div>
                <el-dialog :visible.sync="addDialog" customClass="addDig">
                    ...
                    <div class="body">
                        <input v-model="addTypeText" type="text" placeholder="输入含金量名称">
                    </div>
