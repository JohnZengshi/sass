<template>
    <transition name="tp-ani">
        <div class="model-wrap">
            <div class="model-title"><i class="iconfont icon-liebiao"></i>宝石名称 <span class="add-btn" @click="addBigClass">+类型</span></div>
            <div class="model-content" v-loading="isLoading" element-loading-text="拼命加载中">
                <draggable element="div" v-model="dataList" :options="dragOptionsBig" @end="onEnd">
                    <div class="type-block" v-for="(item, index) in dataList"> <!-- v-for="(item, index) in dataList" -->
                        ...
                        <div class="item-title" @click.stop="operateItem1(item, index)" style="cursor: pointer;">{{item.classesName}}<span class="add-btn" @click.stop="addDialogAct(item, index, 4)">+分类</span></div>
            ...
            <div>
                <el-dialog :visible.sync="addDialog" customClass="addDig">
                    ...
                    <div class="body">
                        <input v-model="addTypeText" type="text" placeholder="输入宝石名称">
                    </div>
                ...
                <el-dialog :visible.sync="addDialog1" customClass="addDig">
                    ...
                    <div class="body1">
                        <div class="body1-wrap">
                            <input class="input1" v-model="addTypeText" type="text" placeholder="输入宝石名称">
