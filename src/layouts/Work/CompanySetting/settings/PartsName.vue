<template>
    <transition name="tp-ani">
        <div class="model-wrap">
            <div class="model-title"><i class="iconfont icon-liebiao"></i>配件名称</div>
            <div class="model-content" >
                <div v-loading="isLoading" element-loading-text="拼命加载中">
                    <div class="type-block">
                        <div class="item-title">配件名称<span class="add-btn" @click="addDialogAct()">+分类</span></div>
            ...
            <div>
                <el-dialog :visible.sync="addDialog" customClass="addDig">
                    ...
                    <div class="body">
                        <input v-model="addTypeText" type="text" placeholder="输入配件名称">
                    </div>
