    ...
    <div class="ope-body">
      <div class="input-block-left">
        ...
        <div v-else class="textarea-wrap">
          <textarea maxlength="50" type="text" v-model="finishedRemark"></textarea>
          <span>{{finishedRemark.length}}/50</span>
        </div>
        <div class="input-block-title">
          <i></i>
          <span>旧料备注</span>
        ...
        <div v-else class="textarea-wrap">
          <textarea maxlength="50" type="text" v-model="oldRemark"></textarea>
          <span>{{oldRemark.length}}/50</span>
        </div>
      </div>
  ...
  methods: {
    ...
    stockData(myChart, option) {
      ...
      seekStockData(options).then((res) => {
        ...
        if (this.stockData1) {
            this.finishedRemark = this.stockData1.finishedRemark
            this.oldRemark = this.stockData1.oldRemark
        }
    ...
    closeDialog() {
      ...
      if (this.operateName == '' && this.addTypeText == undefined && this.value == undefined) {
        ...
        this.$emit("messageBack", {
            ...
            operateId: this.operateId,
            radio: this.radio,
            classesId: this.operateId,
            finishedRemark: this.finishedRemark,
