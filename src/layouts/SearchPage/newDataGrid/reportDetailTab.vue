<template>
    <div class="tab_detail_table">
        ...
        <template>
            <!--表格内容区  -->
            <data-grid-body :printNum="printNum" :tabSwitch="tabSwitch" :detailDataGridColumn="detailDataGridColumn" :dataGridStorage="dataGridStorage" :reportType="reportType" :positionSwitch="positionSwitch" @scrollClass="scrollClass" @lazyloadSend="lazyloadSend" @tabCell="tabCell" @openDialog="openDialog"></data-grid-body>
            <!--表尾  -->
            <data-grid-footer :tabSwitch="tabSwitch" :detailDataGridColumn="detailDataGridColumn" :dataGridStorage="allData" :reportType="reportType" :configData="configData" @tabCell="tabCell"></data-grid-footer>
        </template>
        ...
        <el-dialog :title="productTypeName" top="0" :modal="false" :modal-append-to-body="false" :visible.sync="ListDetails" customClass="ruleOption detailsBounced new-popup-style">
            ...
            <div class="detailsInfo">
                        ...
                        <div>
                            <ul class="item-blobk">
                                <li v-for="(item, index) in sortDataList" :key="index">
                                    <div class="main-name">
                                        <div class="name-wrap">
                                            <span class="line"></span> <span class="name">{{item.label}}</span>
                                        </div>
                                    </div>
                ...
                <div class="detailsInfo_right">
                    <div class="right_top">
                        <div><i class="icon-dian fl">●</i>
                            <p>{{locationName}}</p>
                        </div>
                        <div><i class="icon-dian fl">●</i>
                            <p>{{getProductType(productType)}}</p>
                        </div>
                        <div><i class="icon-dian fl">●</i>
                            <p>{{getProductClass(productClass)}}</p>
                        </div>
                    </div>
                    <div class="right_bottom">
                        <!-- 步骤条 -->
                        <stepsPath :orderListST="orderListST" :productId="productId" :statusREfresh="statusREfresh"></stepsPath>
                    </div>
                </div>
            </div>
        </el-dialog>
