  ...
  data() {
    return {
      ...
      navDataList: [
        {
          type: "个人信息",
          iconSrc: "static/img/admin/ic_xinxi_nor.png",
          iconHoverSrc: "static/img/admin/ic_xinxi_hover.png"
        },
        {
          type: "我的公司",
          iconSrc: "static/img/admin/ic_gongsi_nor.png",
          iconHoverSrc: "static/img/admin/ic_gongsi_hover.png"
        },
        {
          type: "店铺管理",
          iconSrc: "static/img/admin/ic_dianpu_nor.png",
          iconHoverSrc: "static/img/admin/ic_dianpu_hover.png"
        },
        {
          type: "密码设置",
          iconSrc: "static/img/admin/ic_mima_nor.png",
          iconHoverSrc: "static/img/admin/ic_mima_hover.png"
        }
      ],
      navShowSwitch: 0,
      isMask: false,
        ...
        res => {
          ...
          if (res.status === 200) {
            ...
            sessionStorage.setItem(
              "defaultShopId",
              res.data.data.shopList[0].shopId
            );
