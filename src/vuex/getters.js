...
export const compInfo = state => state.base.comInfo // 公司信息
export const companyInfo = state => state.base.seekCompanyInfo // 公司详情
export const userPositionInfo = state => state.base.userPositionInfo // 用户职位信息
/* IM 新 */
...
// 状态类
export const errorCode = state => state.popup.errorCode // 错误提示码
...
// 组织架构
export const organizatonChangeId = state => state.organization.changeId // 列表选中
