...
export const SET_USER_INFO_ITEM = 'SET_USER_INFO_ITEM'
export const SET_COM_INFO = 'SET_COM_INFO' // 公司信息
export const SET_USER_COMPANY_INFO = 'SET_USER_COMPANY_INFO' // 公司详情
export const SET_USER_POSITION_INFO = 'SET_USER_POSITION_INFO' // 用户职位信息
    /* IM 新 */
...
// 权限状态
export const USER_APPLY_APPLYINFO = 'USER_APPLY_APPLYINFO' // 审核弹窗
...
// 组织架构
export const SET_ORGANIZATION_CHANGE = 'SET_ORGANIZATION_CHANGE' // 选中
